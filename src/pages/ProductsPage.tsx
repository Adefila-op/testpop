          ...
          <main className="space-y-6">
              ...
              {featuredCampaign ? (
                <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                  <div className="space-y-4">
                    <p className="text-xs uppercase tracking-[0.28em] text-foreground/60">Creator Investment Card</p>
                    ...
                    <p className="max-w-2xl text-sm leading-7 text-foreground/70">
                      {featuredCampaign.summary || featuredCampaign.description || "Track creator raises, revenue participation, and rights-backed positions from one marketplace board."}
                    </p>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="rounded-[1.4rem] bg-white/75 p-4 shadow-sm">
                      <p className="text-[11px] uppercase tracking-[0.22em] text-[#1d4ed8]">Revenue Rights</p>
                      <p className="mt-2 text-sm font-semibold text-foreground">
                        {(investorPositions[featuredCampaign.id] || 0) > 0
                          ? "Your held units stay eligible for future distributions."
                          : "Collectible units can participate in future distributions."}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {campaignsLoading ? (
              <div className="rounded-[1.8rem] bg-secondary/50 px-6 py-16 text-center text-muted-foreground">
                Loading creator investment cards...
              </div>
            ) : marketplaceError ? (
                  ...
                  return (
                    <article key={campaign.id} className="rounded-[1.7rem] border border-[#dbeafe] bg-white p-5 shadow-[0_18px_45px_rgba(37,99,235,0.08)]">
                      ...
                      <p className="mt-3 text-sm leading-7 text-muted-foreground">
                        {campaign.summary || campaign.description || "A creator-backed rights listing for funding, revenue participation, and catalog upside."}
                      </p>
                      ...
                      <p className="mt-4 rounded-[1.2rem] bg-[#f8fbff] px-4 py-3 text-sm text-muted-foreground">
                        {ownedUnits > 0
                          ? "Your held units stay visible here so you can track creator progress and future revenue distributions."
                          : "Open the creator page to review terms, commit capital, and follow how the raise evolves over time."}
                      </p>
